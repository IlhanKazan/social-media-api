-- ROLES tablosuna veri ekleme (PostgreSQL'de SERIAL otomatik artar, ROLEID belirtmeye gerek yok)
INSERT INTO public.ROLES (role) VALUES
                                              ('ROLE_ADMIN'),
                                              ('ROLE_USER');

-- ACCOUNTS tablosuna veri ekleme (DEFAULT yerine nextval kullanımı)
INSERT INTO public.ACCOUNTS (username, password, email, phone, status, createDate, updateDate, ROLEID) VALUES
                                                                                                                     ...
                                                                                                                     ('furkan', '$2a$10$57ZZlufwwTsl4rX4gCo8rOr203KibczuahXCW5uDswZ3TVaxPTGZa', 'deniz_1298@gmail.com', '05555555557', DEFAULT, NOW(), NULL, 2);

-- POSTS tablosuna veri ekleme
